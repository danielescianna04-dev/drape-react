...
- Strumenti di preview e deploy di applicazioni
...
Utilizzando il Servizio, l'utente accetta integralmente questi Termini e Condizioni. Se non si accettano i termini, non utilizzare il Servizio.
...
- Mantenere la sicurezza delle proprie credenziali
- Notificare immediatamente accessi non autorizzati

Per motivi di sicurezza, l'account può essere attivo su un solo dispositivo alla volta. L'accesso da un nuovo dispositivo terminerà la sessione attiva.
...
- Mining di criptovalute sulle risorse cloud
- Attacchi informatici o hacking non autorizzato
- Violazione di diritti di proprietà intellettuale
- Spam o phishing
- Contenuti illegali, offensivi o discriminatori

La violazione comporta la sospensione immediata dell'account.
...
- Hosting, distribuzione o sviluppo di malware, virus o altri software malevoli
- Invio di spam, email di phishing o conduzione di attacchi di ingegneria sociale
- Archiviazione o distribuzione di contenuti illegali
...
- Codice sorgente dei progetti
- Log di utilizzo del Servizio
- Dati di pagamento (gestiti da Apple tramite In-App Purchase)

### 8.2 Uso dei Dati
- Erogazione e miglioramento del Servizio
- Comunicazioni relative all'account
- Analisi aggregate anonimizzate
- NON vendiamo dati a terzi

### 8.3 AI e Codice
- Il codice può essere inviato a provider AI (Anthropic, OpenAI, Google Gemini, Groq) per elaborazione
- I prompt vengono inviati in forma anonimizzata, senza associazione diretta all'account
- L'utente può disabilitare le funzionalità AI

Per l'informativa completa sulla privacy, consultare la Privacy Policy disponibile nell'App.
...
- L'utente può gestire e cancellare gli abbonamenti nelle Impostazioni del proprio account Apple ID
...
Nessuna delle parti sarà ritenuta responsabile per inadempimenti o ritardi nell'esecuzione dei propri obblighi ai sensi dei presenti Termini qualora tali inadempimenti o ritardi derivino da cause al di fuori del ragionevole controllo. Tali cause includono, a titolo esemplificativo e non esaustivo: calamità naturali (terremoti, alluvioni, uragani), guerre, conflitti armati, terrorismo, pandemie, epidemie, atti o sanzioni governative, controversie sindacali, interruzioni dell'energia elettrica, interruzioni di internet o delle telecomunicazioni, attacchi informatici, oppure il malfunzionamento, la sospensione o il degrado di fornitori di servizi terzi (inclusi ma non limitati a Firebase, fornitori di infrastruttura cloud e fornitori di servizi AI). La parte interessata deve notificare tempestivamente l'altra parte e compiere ragionevoli sforzi per mitigare l'impatto.

---

## 14. Diritti dei Consumatori UE e Diritto di Recesso

### 14.1 Diritto di recesso
Ai sensi della Direttiva UE 2011/83/UE sui diritti dei consumatori, i consumatori residenti nell'Unione Europea hanno il diritto di recedere da un contratto di abbonamento entro 14 giorni di calendario dall'acquisto, senza dover fornire alcuna motivazione.

### 14.2 Eccezione per i contenuti digitali
...
## 15. Cancellazione Account

### 15.1 Da Parte dell'Utente
- L'utente può cancellare l'account in qualsiasi momento
...
I presenti Termini sono regolati dalla legge italiana. Per qualsiasi controversia sarà competente in via esclusiva il Foro di Milano, Italia. Per i consumatori residenti nell'Unione Europea, si applicano altresì le disposizioni imperative in materia di tutela dei consumatori del loro paese di residenza.
