// Script to delete all projects with userId: 'default-user'
...
async function cleanupDefaultProjects() {
  console.log('🔍 Searching for projects with userId: "default-user"...');
...
cleanupDefaultProjects().catch(err => {
