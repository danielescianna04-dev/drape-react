...
- Quando non sei sicuro di qualcosa, ammettilo onestamente`;
        ...
        if (context) {
            ...
            systemMessage += '🚨 COMPORTAMENTO VISIBILE - MOSTRA COSA STAI FACENDO:\n\n';
            systemMessage += '✅ OBBLIGO: Dopo OGNI tool call, scrivi UN BREVE COMMENTO (1-2 righe) su cosa hai scoperto!\n';
            systemMessage += '✅ Usa emoji per rendere visibile il progresso: 📂 🔍 ✅ 🔧 💡\n';
            systemMessage += '✅ Fai vedere all\'utente che stai lavorando attivamente!\n\n';
            ...
            systemMessage += '✅ ESEMPIO CORRETTO (visibile e comunicativo):\n';
            systemMessage += 'User: "Cosa fa questa applicazione?"\n';
            systemMessage += 'Tu: "📂 Inizio l\'esplorazione del codebase..."\n';
            systemMessage += 'Tu: [Chiama read_file(package.json)]\n';
            systemMessage += '[Sistema mostra contenuto]\n';
            systemMessage += 'Tu: "✅ Ho visto che usa React Native ed Expo. Cerco i file TypeScript..."\n';
            ...
            systemMessage += 'Tu: "💡 Vedo che è un IDE mobile! Ora controllo i servizi..."\n';
            systemMessage += '... continua ad esplorare CON commenti visibili ...\n';
            systemMessage += 'Tu: "Ecco l\'analisi completa dell\'applicazione..."\n\n';
